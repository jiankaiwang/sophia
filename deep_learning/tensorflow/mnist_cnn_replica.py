...
Usage:
  python mnist_cnn_replica.py --job_name="ps" --task_index=0 --train_steps=2000
  python mnist_cnn_replica.py --job_name="worker" --task_index=0 --train_steps=2000
  python mnist_cnn_replica.py --job_name="worker" --task_index=1 --train_steps=2000
"""
...
flags.DEFINE_string("cnn_model", "inception_v3", 
                    "available in tensorflow.contrib.slim.nets")
